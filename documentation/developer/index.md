...
<img class="img-responsive" src="/stephanie/img/documentation/directory_structure_root.png">
...
<img class="img-responsive" src="/stephanie/img/documentation/directory_structure_child.png">
...
- Sharing it with Stephanie's main team by using any of the social media links listed below so that we can show it to other users in one single place in the [resources](/stephanie/documentation/resources/modules) section.